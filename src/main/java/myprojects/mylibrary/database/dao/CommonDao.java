package myprojects.mylibrary.database.dao;
...
import myprojects.mylibrary.database.models.BaseModel;
...
public abstract class CommonDao {
    ...
    public <T extends BaseModel, I> void createOrUpdate(BaseModel baseModel) throws ApplicationException {
        ...
        try {
            ...
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.create.update"));
        } finally {
    ...
    public <T extends BaseModel, I> void refresh(BaseModel baseModel) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.refresh"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> void delete(BaseModel baseModel) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.delete"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> T findById(Class<T> cls, Integer id) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.not.found"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> List<T> queryForAll(Class<T> cls) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.not.found.all"));
        } finally {
            this.closeDbConnection();
        }
    }
    ...
    public <T extends BaseModel, I> Dao<T, I> getDao(Class<T> cls) throws ApplicationException {
        try {
            ...
            LOGGER.warn(e.getCause().getMessage());
            throw new ApplicationException(FxmlUtils.getResourceBundles().getString("error.get.dao"));
        } finally {
            this.closeDbConnection();
        }
    }
